...
- Event source is rebuilt from CNINFO title+full-text search and PDF audits.
...
- `docs/empirical_runs/86_v23_qian_supplier_replication_20260602.md`
- `docs/empirical_runs/87_v24_qian_initiative_event_rebuild_20260602.md`
- `docs/empirical_runs/88_v25_cninfo_formal_event_rebuild_20260602.md`
- `docs/empirical_runs/89_v26_cninfo_fulltext_harvest_20260603.md`
- `docs/empirical_runs/90_v27_cninfo_priority_pdf_audit_20260603.md`
- `docs/empirical_runs/91_v27_cninfo_priority_pdf_audit_2023_2026_20260603.md`
